...
let categoryData: [String: [Item]] = [
    "Movies": data[0].items,
    "Books": data[1].items,
    "Music": data[2].items,
    "Courses": data[3].items
]
...
let data: [FavoritesData] = [
    FavoritesData(section: "Favorite Movies", items: [
        Item(
            ...
            review: "A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU.A revolutionary superhero film that launched the MCU."
        ),
        Item(
            image: .rush,
            title: "Rush",
